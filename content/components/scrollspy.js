...
instance.scroll_Id_2 =
  `
<div class="row">
    <div class="col-4">
      <nav id="navbar-example3" class="navbar-demo navbar-light bg-light flex-column">
        <a class="navbar-brand" href="#">Navbar</a>
...
instance.scroll_Id_4 =
  `
body {
  position: relative;
}
`
instance.scroll_Id_5 =
  `
...
instance.scroll_Id_6 =
  `
$('body').scrollspy({ target: '#navbar-example' })
`

instance.scroll_Id_7 =
  `
$('[data-spy="scroll"]').each(function () {
  var $spy = $(this).scrollspy('refresh')
})
`
instance.scroll_Id_8 =
  `
